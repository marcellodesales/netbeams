...
public enum NetBeamsMouseButtonEnum {
     ...
     */
    CENTER_BUTTON(MouseEvent.BUTTON2),
    /**
     ...
     * @return an instance of NetBeamsMouseButton with the given button value based on the value.
     */
    public static NetBeamsMouseButtonEnum getInstanceByValue(int buttonValue) {
        ...
        throw new IllegalArgumentException(
                "Value must be in the range of java.awt.event.MouseEvent.getButton() constants");
    }
}
