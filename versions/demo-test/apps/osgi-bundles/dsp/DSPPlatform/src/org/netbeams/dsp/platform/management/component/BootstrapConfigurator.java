 ...
 * 
 * <DSP component type>: For instance, org.netbeams.dsp.demo.stocks.producer <sequence>: '0' (zero) right padded
 * sequence number. For instance, 001 <content data type>: For instance, stock.tick <message category prefix>: A, C, D,
 * E, I, M, Q, U #11/02/2008 - Kleber Sales - Creation
 * 
 **/
import java.io.File;
...
public class BootstrapConfigurator {
    ...
    // private static Map<String, Class<? extends Message>> prefixToCategory = new HashMap<String, Class<? extends
    // Message>>();
    // static{
		...
		if (files != null) {
		    for (File file: files){
		        ...
		        try {
		            ...
		            MessagesContainer msgsCtn = DSPXMLUnmarshaller.INSTANCE.unmarshallStream(file);
