...
//    @XmlElement(name = "Consumer", required = true)
    ...
    public String toXml() {
        ...
        if (this.creationTime != 0) {
            builder.append("<CreationTime>" + this.creationTime + "</CreationTime>");
        }
        if (this.correlationID != null && !this.correlationID.equals("")) {
            builder.append("<CorrelationID>" + this.correlationID + "</CorrelationID>");
        }
        builder.append("<Producer>");
        builder.append(this.producer.toXml());
        builder.append("</Producer>");
        builder.append("<Consumer>");
        builder.append(this.consumer.toXml());
        builder.append("</Consumer>");
        builder.append("</Header>");
