...
// getElement() -- returns ALL the Elements in a NEW array.
// NOTE: the elements are NOT cloned unless they are primitive type.
...
// sort() - sorts the collection based on the RETURNED value of a function - f
function sortByFunction(f) {
	var i, j;
	var currentValue;
	var currentObj;
	var compareObj;
