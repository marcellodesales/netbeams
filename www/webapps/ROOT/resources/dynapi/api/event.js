...
/*********************************************************************************************************
	There was a BUG that cause this function to fail when layer 'p' DOES NOT have a parent.
	It is POSSIBLE that 'p' does not have a parent because 'p' might NOT be added to a parent layer
	yet OR have been removed from a parent layer. Below is the new code
 *********************************************************************************************************/

p.updateAnchor = function() {
	if (this.parent)							// make sure the layer have a parent before
		this.parent._updateAnchor(this.id);		// calling the _updateAnchor function
};
