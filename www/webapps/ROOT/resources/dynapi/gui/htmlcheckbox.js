...
//	var evt,value=this._value||'';						// ORIGINAL SOURCE

/********************************************************************************************/
	var evt,value=this.getValue()||'';					// MODIFIED SOURCE
/********************************************************************************************/
...
/*	
	ORIGINAL SOURCE CODE WITHOUT ENABLE OR DISABLE ATTRIBUTE
...
/*********************   NEW SOURCE CODE WITH 'DISABLED' ATTRIBUTE    *****************************************/
	...
	return '<input ' + disabled + ' type="checkbox" class="'+this._class+'" id="'+this._elmId+'" name="'+this._elmId+'" value="'+value+'" '
	+sel+evt+' title="'+this._title+'" />';
/*********************   NEW SOURCE CODE WITH 'DISABLED' ATTRIBUTE    *****************************************/
...
/************************   NEW SOURCE CODE    ********************************************
	There is a BUG in the setState() function. Originally, the state value is assigned
	to 'this.elm.selected'. It should be assigned to 'this.elm.checked' instead.
******************************************************************************************/
