...
//	var wrap,evt,text=this._text||'';					ORIGINAL SOURCE CODE

/********************************************************************************************/
	var wrap,evt,text=this.getText()||'';				//	MODIFIED SOURCE CODE
/********************************************************************************************/
...
/*********************   NEW SOURCE CODE WITH 'DISABLED' ATTRIBUTE    *****************************************/
	...
	return '<textarea ' + disabled + ' class="'+this._class+'" id="'+this._elmId+'" name="'+this._elmId+'" cols="'+this._cols+'" rows="'+this._rows+'" '
	+wrap+readstate+evt+' title="'+this._title+'">'+text+'</textarea>';
