...
//	var max,evt,text=this._text||'';			 ORIGINAL SOURCE CODE

/***************************************************************************************/
	var max,evt,text=this.getText()||'';			// MODIFIED SOURCE
/***************************************************************************************/
...
/*
	OLD SOURCE CODE WITHOUT DISABLE ATTRIBUTE
...
/*********************   NEW SOURCE CODE WITH 'DISABLED' ATTRIBUTE    *****************************************/
	...
	return '<input ' + disabled + ' type="'+((!this._mask)? 'text':'password')+'" class="'+this._class+'" id="'+this._elmId+'" name="'+this._elmId+'" size="'+this._size+'" value="'+ text +'" '
	+readstate+max+evt+' title="'+this._title+'" />';
