...
<%!
	public void drawImage (Graphics2D g, int width, int height) {
		...
		if (height < minHeight || width < minWidth) {
			...
			g.setColor(new Color(255, 225, 225, 255));
			g.fillPolygon(x, y, 4);
			...
			// draw the LOOP lines
			g.setColor(new Color(255, 0, 0, 255));
			g.drawLine(width - 1 - arrowLength, (titleHeight / 2) + 1, width - 1, (titleHeight / 2) + 1);
			g.drawLine(width - 1, (titleHeight / 2) + 1, width - 1, height - 1);
			g.drawLine(width - 1, height - 1, 1, height - 1);
			g.drawLine(1, height - 1, 1, (titleHeight / 2) + 1);
			g.drawLine(1, (titleHeight / 2) + 1, arrowLength + 1, (titleHeight / 2) + 1);
			
			// draw the arrow
			g.drawLine(arrowLength + 1 - arrowWidth, (titleHeight / 2) + 1 - arrowWidth, arrowLength + 1, (titleHeight / 2) + 1);
			g.drawLine(arrowLength + 1 - arrowWidth, (titleHeight / 2) + 1 + arrowWidth, arrowLength + 1, (titleHeight / 2) + 1);
