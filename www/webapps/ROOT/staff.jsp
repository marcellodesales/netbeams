		...
		<tr>
			<td class="navigationBar">
				<table border="0" width="250px" id="table3" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<a href="staff.jsp"><b>About NetBEAMS Staff</b></a><br>
			...
			<td class="content_body">
				<table border='0' cellspacing='0' cellpadding='0'>
					<tr>
						<td class='title' align='center'>NetBEAMS Staff
					</tr>
					<tr>
						<td align='left'>
							The project team
							...
							team needed to address this difficult domain.<br><br>
						</td>
					</tr>
						...
						<table border='0' cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td align='left' valign='top'>
									<img border="1" src="resources/todor.jpg" width="100" height="120">
								</td>
								<td align='left' valign='top' style='padding-left:5px;'>
									<b>Dr. Todor Cooklev</b> is an Assistant Professor of
						...
						<table border='0' cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td align='left' valign='top' style='padding-right:5px;'>
									<b>Glenn Engel</b> has a extensive experience in embedded instrumentation ranging from multi
								...
								<td align='left' valign='top'>
									<img border="1" src="resources/glenn.jpg" width="100" height="120">
								</td>
							</tr>
						</table>
					</td></tr>
					...
					<tr><td style='padding-top:10px;'>
						<table border='0' cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td align='left' valign='top'>
									<img border="1" src="resources/toby.jpg" width="100" height="120">
								</td>
								<td align='left' valign='top' style='padding-left:5px;'>
									<b>Dr. Toby Garfield</b> has extensive experience in
					...
					<tr><td style='padding-top:10px;'>
						<table border='0' cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								...
								<td align='left' valign='top'>
									<img border="1" src="resources/bill.jpg" width="100" height="120">
								</td>
							</tr>
						</table>
					</td></tr>
					...
					<tr><td style='padding-top:10px;'>
						<table border='0' cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td align='left' valign='top'>
									<img border="1" src="resources/david.jpg" width="100" height="120">
								</td>
								<td align='left' valign='top' style='padding-left:5px;'>
									<b>Tai-Wei Lin</b> is an engineer at Sun Microsystems, Inc.
					...
					<tr><td style='padding-top:10px;'>
						<table border='0' cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td align='left' valign='top' style='padding-right:5px;'>
									<b>James C. Liu</b>, Ph.D. is a Sr. Staff Engineer at Sun
								...
								<td align='left' valign='top'>
									<img border="1" src="resources/james_liu.jpg" width="100" height="120">
								</td>
							</tr>
						</table>
					</td></tr>
					...
					<tr><td style='padding-top:10px;'>
						<table border='0' cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td align='left' valign='top'>
									<img border="1" src="resources/jerry.jpg" width="100" height="120">
								</td>
								<td align='left' valign='top' style='padding-left:5px;'>
									<b>Jerry Liu</b> is a research
									scientist <span style="color: #333333">at Agilent Laboratories,
					...
					<tr><td style='padding-top:10px;'>
						<table border='0' cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td align='left' valign='top' style='padding-right:5px;'>
									<b>Dr. Dragutin Petkovic</b> heads the Computer Science
								...
								<td align='left' valign='top'>
									<img border="1" src="resources/dragutin.jpg" width="100" height="120">
								</td>
							</tr>
						</table>
					</td></tr>
					...
					<tr><td style='padding-top:10px;'>
						<table border='0' cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td align='left' valign='top'>
									<img border="1" src="resources/arno.jpg" width="100" height="120">
								</td>
								<td align='left' valign='top' style='padding-left:5px;'>
									<b>Dr. Arno Puder (PI) </b>is an expert in middleware
					...
					<tr><td style='padding-top:10px;'>
						<table border='0' cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								...
								<td align='left' valign='top'>
									<img border="1" src="resources/glen.jpg" width="100" height="120">
								</td>
							</tr>
						</table>
					</td></tr>
					...
					<tr><td style='padding-top:10px;'>
						<table border='0' cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td align='left' valign='top'>
									<img border="1" src="resources/gary.jpg" width="100" height="120">
								</td>
								<td align='left' valign='top' style='padding-left:5px;'>
									<b>Gary Thompson</b> is currently a MS CS candidate at SFSU
					...
					<tr><td style='padding-top:10px;'>
						<table border='0' cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td align='left' valign='top' style='padding-right:5px;'>
									<b>James Todd</b> is a member of the JXTA team at Sun
									...
									special projects.<br>James is happily married to Tammy for
									...
									at this time.<br>James has a dual BS degree in Computer
									Science and Applied Mathematics and was raised in
									Grand Junction on the western slope of Colorado.
								</td>
								<td align='left' valign='top'>
									<img border="1" src="resources/james_todd.jpg" width="100" height="120">
								</td>
							</tr>
						</table>
					</td></tr>
					...
					<tr><td style='padding-top:10px;'>
						<table border='0' cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td align='left' valign='top'>
									<img border="1" src="resources/jay.jpg" width="100" height="120">
								</td>
								<td align='left' valign='top' style='padding-left:5px;'>
									<b>Dr. Jay Warrior</b> leads distributed systems research at
					...
					<tr><td style='padding-top:10px;'>
						<table border='0' cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td align='left' valign='top' style='padding-right:5px;'>
									<b>James Wright</b> is a Senior Solutions Architect at Sun
								...
								<td align='left' valign='top'>
									<img border="1" src="resources/jim.jpg" width="100" height="120">
								</td>
							</tr>
						</table>
					</td></tr>
					...
					<tr><td style='padding-top:10px;'>
						<table border='0' cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td align='left' valign='top'>
									<img border="1" src="resources/brian.jpg" width="100" height="120">
								</td>
								<td align='left' valign='top' style='padding-left:5px;'>
									<b>Brian Zambrano</b> is a MS candidate in Computer Science
					...
					<tr><td style='padding-top:10px;'>
						<table border='0' cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								...
								<td align='left' valign='top' style='padding-left:5px;'><br>
									Logo designed by <b>Christopher Kriese.</b>
								</td>
							</tr>
						</table>
					</td></tr>
